...
- [Parallel tool use | 🦜️🔗 Langchain](https://python.langchain.com/docs/use_cases/tool_use/parallel) - Run parallels calls
...
- [Fixing Hallucinations in LLMs. Why LLMs hallucinate, approaches for… | by Sergei Savvov | Better Programming](https://betterprogramming.pub/fixing-hallucinations-in-llms-9ff0fd438e33)
